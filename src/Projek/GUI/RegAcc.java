...
import Projek.CLASS.AkunDokter;
import Projek.CLASS.Akun;
import Projek.CLASS.AkunPerawat;
import Projek.CLASS.AkunPegawai;

/**
 * Sebuah class yang bertujuan untuk melakukan registrasi sehingga data-data
 * pekerja rumah sakit dapat disimpan di database
 * 
 * @author Alphancoders
 * @version 2021.20.11
 */
public class RegAcc 
{
    ...
    // convert dia ke string karena data bilangan ini akan di simpan di file
    // database beresktensi .txt
    ...
    /**
     * Membuat method menambah akun dokter kedalam database
     * @param data
     * @throws IOException
     */
    ...
    /**
     * Membuat method menghapus akun dokter dari database
     * @param id
     * @throws IOException
     */
    ...
    /**
     * Method untuk mengecek ID Dokter didalam database
     * @param id
     * @return dataWujud
     * @throws IOException
     */
    ...
    /**
     * Membuat method menambah akun Perawat kedalam database
     * @param data
     * @throws IOException
     */
    ...
    /**
     * Membuat method menghapus akun perawat dari database
     * @param id
     * @throws IOException
     */
    ...
    /**
     * Membuat method mengecek ID perawat pada database
     * @param id
     * @return
     * @throws IOException
     */
    ...
    /**
     * Membuat method untuk menambah akun pegawai kedalam database
     * @param data
     * @throws IOException
     */
    ...
    /**
     * Membuat method untuk menghapus akun pegawai dari database
     * @param id
     * @throws IOException
     */
    ...
    /**
     * Membuat method untuk mengecek ID pegawai pada database
     * @param id
     * @return
     * @throws IOException
     */
